...
export const stockColumns = [
  ...
  { key: 'STOK_TIP_ADI', label: 'Tip' },
  { key: 'BIRIM1', label: 'Birim' },
  { key: 'DURUM', label: 'Durum' },
]

export const variantColumns = [
  { key: 'STOK_VARYANT_NO', label: 'Varyant No' },
  { key: 'VARYANT_KODU', label: 'Varyant Kodu' },
  { key: 'VARYANT_ADI', label: 'Varyant Adı' },
